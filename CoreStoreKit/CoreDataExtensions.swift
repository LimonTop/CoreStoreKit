...
public struct CoreStoreKit {
     ...
     */
    public static func saveContext(context: NSManagedObjectContext, wait: Bool = true, completion: ((NSError?) -> Void)? = nil) {
     ...
     */
    public static func entity(name name: String, context: NSManagedObjectContext) -> NSEntityDescription {
     ...
     */
    public static func fetch <T: NSManagedObject>(request request: CoreStoreFetchRequest<T>, inContext context: NSManagedObjectContext) throws -> [T] {
     ...
     */
    public static func deleteObjects <T: NSManagedObject>(objects: [T], inContext context: NSManagedObjectContext) {
 ...
 */
public class CoreStoreFetchRequest <T: NSManagedObject>: NSFetchRequest {
